...
void main() {
  group('Desktop document format support', () {
    const desktopSupported = {'txt', 'md', 'html', 'htm'};
    const serverFormats = ['pdf', 'docx', 'txt', 'md', 'html'];

    test('desktop supported formats include text-based types only', () {
    ...
    test('desktop mode does NOT include PDF/DOCX', () {
      expect(desktopSupported.contains('pdf'), isFalse);
