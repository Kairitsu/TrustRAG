...
|--------|-----|------|------|------|------|------|------|
| P0 | E-24.1 | #24 | 聊天「停止生成」按钮 | 前端 | 低 | 30min | ✅ DONE |
| P0 | E-24.2 | #24 | 首 token 超时检测 (30s) | 前端 | 低 | 30min | ✅ DONE |
| P0 | E-23.1 | #23 | 文档「重新处理」按钮 | 前后端 | 中 | 1h | ✅ DONE |
| P1 | E-24.3 | #24 | 后端 SSE 增加 retrieval_started/finished 事件 | 后端 | 中 | 1.5h | ✅ DONE |
| P1 | E-24.4 | #24 | 前端消费 SSE 阶段事件并展示 | 前端 | 中 | 1h | ✅ DONE |
| P1 | E-23.2 | #23 | 后端文档处理进度字段 (chunks_total/done) | 后端 | 中 | 1.5h | ✅ DONE |
| P1 | E-23.3 | #23 | 前端文档列表显示处理进度 | 前端 | 低 | 45min | ✅ DONE |
| P1 | E-25.1 | #25 | 资料库文档列表显示图谱生成状态 badge | 前后端 | 中 | 1.5h | ✅ DONE |
| P1 | E-25.2 | #25 | 图层过滤为空时的友好提示 | 前端 | 低 | 30min | ✅ DONE |
